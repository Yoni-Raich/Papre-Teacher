...
class PaperTicher:
    ...
    def get_system_prompt(self):
        ...
        בנוסף אם בקטע מהמאמר אותו אתה מסכם הכותבים מציינים מקרות כלומר מספר מקור בתוך [] סוגריים מרובעים אז בהסבר שלך אם הוא מתקשר להסבר במאמר שמציין מקור תציין גם את מספר המקור 
        תענה בעברית
